...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/XXyueliang/cocoapodTest.git"
  ...
  spec.author             = { "lixin" => "" }
  # Or just: spec.author    = "lixin"
  # spec.authors            = { "lixin" => "" }
  # spec.social_media_url   = "https://twitter.com/lixin"
  ...
  spec.source       = { :git => "https://github.com/XXyueliang/cocoapodTest.git", :tag => "#{spec.version}" }
